...
module.exports = function() {
  ...
  var addMockedResponse = function (method, endpoint, code, body) {
  ...
  var prepareMocks = function(mocks) {
    ...
    var mockIt = function(mock_params) {
      mock[mock_params.method](mock_params.endpoint, function(req, res) {
        var response = res
  ...
  var waitForRequestToBeMade = function(method, endpoint, body, callback) {
    var results;
    for (var i = 0; i < 10; i++) {
      var results = checkRequestWasMade(method, endpoint, body)
      if (results.found) {
        break;
      }
      client.pause(200);
    ...
    if (results.found) {
      ...
      callback(requestsError(results.requests))
    }
  };

  var checkRequestWasMade = function(method, endpoint, body) {
    ...
    var found = requests.reduce(
      function(found, req) {
        return found || requestEqual(req, {method, endpoint, body: body});
      }, false
    )
  ...
  var requestsError = function(encouteredRequests) {
    return new Error(
      "Request wasn't made." +
